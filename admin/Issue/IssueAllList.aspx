<%@ Page Title="All Issue List" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin.master" CodeBehind="IssueAllList.aspx.vb" Inherits="test1.IssueAllList" %>
        ...
        <asp:Repeater ID="users" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" NavigateUrl='<%# String.Format("~/admin/Issue/IssueView.aspx?Id={0}&Subject={1}&Description={2}&Author={3}&Date={4}",

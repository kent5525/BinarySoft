<%@ Page Title="Issue List" Language="vb" AutoEventWireup="false" MasterPageFile="~/customer.master" CodeBehind="IssueList.aspx.vb" Inherits="test1.IssueList1" %>
        ...
        <asp:Repeater ID="users" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink runat="server" NavigateUrl='<%# String.Format("~/customer/Issue/IssueDetail.aspx?Id={0}&Subject={1}&Description={2}&Author={3}&Date={4}",
